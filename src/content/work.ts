...
export const work: CaseStudy[] = [
  ...
  },
  {
    ...
    cover: { kind: "photo", src: "/work/kinein.webp", alt: "The Kinein B2B e-commerce storefront" },
    metrics: [],
    challenge: {
      heading: "Challenge",
      body: [
        "Distributors and manufacturers running B2B storefronts often keep their commerce platform and their accounting system out of sync, re-keying orders, inventory, and customer-specific pricing by hand between the two, or bolting on middleware that adds another point of failure.",
      ],
    },
    approach: {
      heading: "Approach",
      body: [
        "The build followed the same approach we use on every engagement: prove the riskiest technical assumption first, then ship in short, working increments so progress is visible throughout rather than held back for a single reveal.",
      ],
    },
    solution: {
      heading: "Solution",
      body: [
        "The result is a wholesale storefront for distributors and manufacturers where inventory, customer-specific pricing, and orders move both ways between the site and Fishbowl, Acumatica, QuickBooks, or Xero, with no middleware and no re-keying.",
        "The platform also supports multi-warehouse inventory and a dedicated sales rep portal.",
      ],
    },
    stack: [],
    results: {
